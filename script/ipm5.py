...
warped_size = np.array([680, 480])
original_size = np.array([480, 680])
OFFSET =0
...
mtx = np.array([[564.1794158410564, 0, 339.585354927923], [0, 563.8954010066177, 240.8593643042658], [0, 0, 1]])
...
def message_RGB_ReceivedCallback(message):
    ...
    #img_rbg = cv2.resize(img_rbg, (640,480))
...
def calc_warp_points():
    ...
    src = np.float32 ([
        [218, 191], [462, 191], [530, 374], [151, 374]
    ])

    dst = np.float32 ([
            [202, 125], [480, 125], [480, 404], [202, 404]
        ])
